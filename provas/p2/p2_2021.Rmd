...
tabela1 |> 
  ...
  dplyr::mutate(p_valor = purrr::map_dbl(
    estat_t,
    ~ round(2 * pt(.x, df = n-k-1, lower.tail = F), 4)
  )) |> 
...
#' e não tem informações sobre o número total de coeficientes
