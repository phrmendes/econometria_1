...
c.  Calcule $E(X)$ e $Var(X)$.\
    ...
    &=\int_{-\infty}^0 0xdx+\int_0^1 \frac{2}{9}x(x-1)dx+\int_1^2 \frac{2}{9}x(x+1)dx +\\
    &\int_2^3 \frac{2}{9}x^2dx+\int_3^\infty 0xdx \\
    &=0-\frac{1}{27}+\frac{23}{27}+\frac{38}{27}+0 \\
    &=\frac{20}{9}
    \end{aligned}$$

    $$\begin{aligned}Var(X)&=\int_{D_x}(x-E(x))^2f(x)dx=E(X^2)-E(X)^2 \\
    E(X^2)&=\int_{-\infty}^0 0x^2dx+\int_0^1 \frac{2}{9}x^2(x-1)dx+\int_1^2 \frac{2}{9}x^2(x+1)dx+ \\
    &\int_2^3 \frac{2}{9}x^3dx+\int_3^\infty 0x^2dx \\
