...
: Tabela 4): Médias e variâncias para a renda per capita dentro das subamostras

5.  Seja $X_1,X_2,…,X_N$ uma sequência de variáveis aleatórias (VAs) independentes e identicamente distribuídas (i. i. d.) com média e variância populacionais dadas, respectivamente, por $\mu$ e $\sigma^2$, i. e., $E[X_i]=\mu$ e $V[X_i]=\sigma^2$, $i=1,…,N$. Responda as perguntas abaixo:
