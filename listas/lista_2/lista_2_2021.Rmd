...
| Parâmetro             | Estimativa pontual    | Unidade de medida                                                |
+:=====================:+:=====================:+:================================================================:+
| Intercepto            | 1,73                  | Log (R\$/hora) ou porcentagem                                    |
+-----------------------+-----------------------+------------------------------------------------------------------+
| Coeficiente           | 0,25                  | Log (R\$/hora) / Log (anos de estudo) ou porcentagem/porcentagem |
+-----------------------+-----------------------+------------------------------------------------------------------+
...
$$
\hat{\beta}_{1}=\frac{\sum_{i=1}^{N} \tilde{y}_{i} \tilde{x}_{i}}{\sum_{i=1}^{N}\left(\tilde{x}_{i}\right)^{2}}
$$
...
$$
R^{2}=1-\frac{S Q R}{S Q T}=1-\frac{\sum_{i=1}^{N}\left(y_{i}-\hat{\beta}_{0}-\hat{\beta}_{1} x_{i}\right)^{2}}{S Q T}=1-\frac{\sum_{i=1}^{N}\left(\hat{u}_{i}\right)^{2}}{\sum_{i=1}^{N}\left(\tilde{y}_{i}\right)^{2}}
$$
