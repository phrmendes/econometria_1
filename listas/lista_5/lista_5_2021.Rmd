...
f_longa_tabela <- geepc~log1p(pibpc)+log1p(epc)+log1p(apc)+d_dev_ing+d_dev_tra+d_reg_afr+d_reg_asi+d_reg_cam+d_reg_nam+d_reg_sam+d_reg_oce
  
lm(f_longa_tabela,data=db_gee)
...
2.  *Há alguma variável cuja insignificância estatística é contra-intuitiva?*\
    Sim, `d_reg_sam` não ser significante é contra-intuitivo pelo fato do Brasil ser um grande emissor de gases do efeito estufa por conta do desmatamento.
